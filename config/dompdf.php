...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * Only the original "Base 14 fonts" are present on all export viewers. Additional fonts must
         * be embedded in the export file or the PDF may not display correctly. This can significantly
         ...
         *
         * The export standard "Base 14 fonts" are:
         ...
         * and {@link CPDF_Adapter} and lib/class.export.php for more information
        ...
        /**
         * html target media view which should be rendered into export.
         * List of types and parsing rules for future extensions:
         * http://www.w3.org/TR/REC-html40/types.html
         *   screen, tty, tv, projection, handheld, print, braille, aural, all
         * Note: aural is deprecated in CSS 2.1 because it is replaced by speech in CSS 3.
         * Note, even though the generated export file is intended for print output,
         ...
         *
         * In export, always 1 pt = 1/72 inch
         *
